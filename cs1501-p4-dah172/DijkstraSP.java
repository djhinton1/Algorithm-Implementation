...
public class DijkstraSP {
     ...
     * vertex in the edge-latencyed digraph {@code G}.
     *
     * @param  G the edge-latencyed digraph
     * @param  s the source vertex
     * @throws IllegalArgumentException if an edge latency is negative
     * @throws IllegalArgumentException unless {@code 0 <= s < V}
     */
    public DijkstraSP(GraphedNetwork G, int s) {
        for (Edge e : G.edges()) {
            if (e.latency() < 0)
    ...
    private boolean check(GraphedNetwork G, int s) {
